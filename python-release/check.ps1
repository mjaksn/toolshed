...
.DESCRIPTION
    ...
    only git. They build small Python projects in a temporary directory, each
    with a bare repository beside it standing in for origin, so running this
    check never pushes anywhere and never talks to GitHub.
