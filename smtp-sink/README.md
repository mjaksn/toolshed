...
| `message.incomplete` | True when the message had more than 5000 header fields or 1000 parts, counting every part's, and the rest were left out of the fields above. They are still in `raw`. |
